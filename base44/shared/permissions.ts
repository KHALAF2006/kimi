...
export const RESERVED_ROLE_TEMPLATES = [
  { code: "support_agent", name_ar: "موظف الدعم", name_en: "Support Agent", permissions: ["dashboard.owner.read", "customers.masked.read"] },
  { code: "subscription_manager", name_ar: "مدير الاشتراكات", name_en: "Subscription Manager", permissions: ["dashboard.owner.read", "customers.masked.read", "subscriptions.read", "subscriptions.manage"] },
  ...
  { code: "compliance_auditor", name_ar: "مراقب الامتثال", name_en: "Compliance Auditor", permissions: ["dashboard.owner.read", "customers.masked.read", "subscriptions.read", "audit.read"] },
];
