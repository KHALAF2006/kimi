// GENERATED from usOptionsSignalProjectionWorker/source.ts. Do not edit directly.

// base44/functions/usOptionsSignalProjectionWorker/source.ts
...
Deno.serve(async (req) => {
  try {
    ...
    if (!["projection_batch", "projection_finalize"].includes(body.mode)) throw Object.assign(new Error("A bounded U.S. options projection worker mode is required"), { status: 400, code: "INVALID_PROJECTION_WORKER_MODE" });
    const response = await base44.functions.invoke("usOptionsSignalRefresh", body);
