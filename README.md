...
قبل النشر يجب أن تنجح الاختبارات، ثم تُزامن 46 كيانًا مخصصًا و22 وظيفة إلى بيئة الاختبار. يمكن تشغيل المصدر العام بلا أسرار، بينما يحتاج محول المزود إلى خرائط الأسهم الـ270 وإعداداته.
