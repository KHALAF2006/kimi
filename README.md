...
منصة عربية/إنجليزية متعددة الأسواق. تدعم السوق الرئيسية السعودية وسوقًا مستقلًا من 110 شركات أمريكية ذات عقود خيارات، مع اشتراك منفصل لكل سوق وعزل كامل للسوق النشط. هذا المستودع هو تنفيذ Full-stack لـBase44، وليس واجهة عرض منفصلة.
...
- تبقى جداول السوق السعودي الحالية داخل `base44/workflows/Market*.jsonc`. أما وظائف السوق الأمريكي الجديدة فتعرّف جداولها داخل `function.jsonc` وفق صيغة Base44 الرسمية الحالية وتُنشر ذريًا مع الوظيفة؛ يجب التحقق من ظهورها في لوحة التطبيق قبل تفعيل الاشتراك.
...
قبل النشر يجب أن تنجح الاختبارات، ثم تُزامن 46 كيانًا مخصصًا و26 وظيفة إلى بيئة الاختبار. السوق الأمريكي يحفظ الشموع التاريخية مرة واحدة، ويحدث معلومات الشركات بدفعات دوارة من مصادر SEC وNasdaq ومحول إجراءات الشركات. تحققت مطابقة CIK لجميع رموز الكتالوج الأمريكي `110/110` مع دليل SEC الرسمي.
