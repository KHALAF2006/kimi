...
هذا المستودع يحتوي تعريفات Backend مستقلة داخل `base44/`. دمج فرع GitHub في تطبيق Base44 Editor يزامن كود الواجهة، لكنه **لا ينشئ الكيانات**؛ توثيق Base44 ينص صراحةً على أن كيانات تطبيقات GitHub تُدار داخل Base44 ولا تُضمّن في المستودع.
