...
export default function StatusPanel({ loading = false, error = "", title="لا توجد نتائج متاحة" }) {
  ...
  const message=sessionExpired?"انتهت الجلسة؛ سجّل الدخول مجددًا للمتابعة.":error?"تعذر عرض البيانات الآن. حاول مرة أخرى بعد قليل.":"لا توجد بيانات لهذا القسم حالياً.";
