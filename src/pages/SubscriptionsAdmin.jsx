    ...
    <div className="mx-auto max-w-[1800px] space-y-5 px-4 pb-10">
      ...
      {can("plans.manage") && entitlementEditor.plan_id && <section className="rounded-2xl border border-amber-400/30 bg-amber-400/10 p-5">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-4">{entitlementCatalog.map(([code, label]) => {
          ...
          return <label key={code} className="rounded-xl border border-amber-400/20 bg-white/70 p-3 dark:bg-slate-950/40">
