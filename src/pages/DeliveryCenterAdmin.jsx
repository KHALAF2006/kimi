...
export default function DeliveryCenterAdmin() {
  ...
  const [state, setState] = useState({ loading: true, busy: "", error: "", success: "", markets: [], channels: [], campaigns: [] });
  ...
  async function load() {
    ...
    try {
      ...
      setState((value) => ({ ...value, loading: false, markets: data.markets || [], channels: data.channels || [], campaigns: data.campaigns || [], busy: "" }));
