...
export default function ResetPassword(){
  ...
  if(!resetToken)return <AuthLayout icon={AlertTriangle} title={t.invalid} subtitle={t.invalidSub} footer={<Link to="/forgot-password" className="font-medium text-primary hover:underline">{t.newLink}</Link>}><p className="text-center text-sm text-foreground">{t.invalidBody}</p></AuthLayout>;
