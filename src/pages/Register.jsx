...
const copy = {
  ar: {
    ...
    phone: "رقم الجوال بصيغة دولية", phoneHelp: "اكتب رقمك الحالي بدقة؛ سنستخدمه لإرسال روابط التدريب والتواصل معك عبر واتساب أو تيليجرام. الرقم الخاطئ قد يؤدي إلى رفض الطلب، ولن نرسل رمز تحقق للجوال.", phoneAcknowledgement: "أؤكد أن رقم الجوال المكتوب هو رقمي الحالي والمسؤول عن استقبال روابط التدريب والتواصل.", country: "الدولة",
...
export default function Register() {
  ...
  const [form, setForm] = useState({ full_name: "", email: "", phone_e164: "", country_code: "SA", market_code: "SA_MAIN", trading_platform_id: "", password: "", confirm: "", email_otp: "", consent: false, phone_accuracy_acknowledged: false });
