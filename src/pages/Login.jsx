...
const copy = {
  ar: { title: "تسجيل الدخول", intro: "الوصول الآمن إلى حسابك", otpIntro: "أدخل الرمز المرسل إلى بريدك", verifiedIntro: "أكمل التحقق الثنائي لحسابك", verified: "حسابك جاهز للمتابعة", sendTo: "سنرسل رمز دخول جديدًا إلى", email: "البريد الإلكتروني", password: "كلمة المرور", remember: "تذكرني على هذا الجهاز", forgot: "نسيت كلمة المرور؟", otp: "رمز التحقق", next: "متابعة", sendCode: "إرسال رمز التحقق", confirm: "تأكيد الدخول", loading: "جارٍ المتابعة…", noAccount: "ليس لديك حساب؟", register: "إنشاء حساب", error: "تعذر تسجيل الدخول" },
  en: { title: "Sign in", intro: "Secure access to your account", otpIntro: "Enter the code sent to your email", verifiedIntro: "Complete two-factor verification for your account", verified: "Your account is ready", sendTo: "We will send a new sign-in code to", email: "Email address", password: "Password", remember: "Remember me on this device", forgot: "Forgot your password?", otp: "Verification code", next: "Continue", sendCode: "Send verification code", confirm: "Confirm sign in", loading: "Please wait…", noAccount: "Don't have an account?", register: "Create account", error: "Unable to sign in" },
};
