...
- نشر GitHub لا يعني نشر Base44؛ لا تصل التغييرات إلى الموقع الحي حتى تُنشر وظائف `marketRead` و`marketSignalRefresh` ثم الواجهة على تطبيق الإنتاج المحدد.
- بعد النشر يجب تشغيل `marketSignalRefresh` مرة واحدة بعد إغلاق جلسة مكتملة لتكوين اللقطات المحفوظة بالإصدار الجديد، ثم فحص شركة لها كسر معروف على الفاصل اليومي والأسبوعي والشهري.
