...
- ثبت أن محرر Base44 يعرض المعاينة داخل إطار ذي تخزين مقسّم عن التبويب المستقل؛ لذلك أضيف تمرير جلسة محدود بنطاقات معاينة Base44 فقط عند فتح رابط داخلي في تبويب جديد، مع تمرير نسخة وظائف المعاينة نفسها، ثم يُمسح جزء المصادقة من الرابط فورًا. روابط الإنتاج لا تحمل هذا التمرير وتستمر عبر التخزين المشترك للأصل نفسه.
